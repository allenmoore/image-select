 ...
 * @returns {void}
 */
var NewImage = function (_Vue) {
	_inherits(NewImage, _Vue);
  ...
  */
	function NewImage() {
		...
		_vue2.default.component('image-list', {
			template: '\n\t\t\t\t<div class="cmm-images">\n\t\t\t\t\t<ul class="image-list">\n\t\t\t\t\t\t<li v-for="image in images" class="image-item">\n\t\t\t\t\t\t\t{{ image.name }}\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t'
		});
		return _possibleConstructorReturn(this, (NewImage.__proto__ || Object.getPrototypeOf(NewImage)).call(this, { el: '#root' }));
	}
