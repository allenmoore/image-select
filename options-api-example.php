...
add_action( 'admin_menu', 'Cmmarslender\ImageSelect\add_admin_page' );
add_action( 'admin_init', 'Cmmarslender\ImageSelect\register_settings' );
...
function register_settings() {
	...
	add_settings_field( $option_name, 'Settings Field Title 1', 'Cmmarslender\ImageSelect\render_image_select', get_settings_page_slug(), get_settings_section(), $render_args );
	...
	add_settings_field( $option_name, 'Settings Field Title 2', 'Cmmarslender\ImageSelect\render_image_select', get_settings_page_slug(), get_settings_section(), $render_args );
	register_setting( get_settings_section(), $option_name, 'intval' );
